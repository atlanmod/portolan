 ...
 * <ul>
 *   <li>{@link kml.impl.ObjectImpl#getId <em>Id</em>}</li>
 *   <li>{@link kml.impl.ObjectImpl#getTargetId <em>Target Id</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public abstract class ObjectImpl extends EObjectImpl implements kml.Object {
	/**
	...
	protected EClass eStaticClass() {
		return KmlPackage.Literals.OBJECT;
	}
	...
	public void setId(String newId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, KmlPackage.OBJECT__ID, oldId, id));
	}
	...
	public void setTargetId(String newTargetId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, KmlPackage.OBJECT__TARGET_ID, oldTargetId, targetId));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case KmlPackage.OBJECT__ID:
				return getId();
			case KmlPackage.OBJECT__TARGET_ID:
				return getTargetId();
		}
