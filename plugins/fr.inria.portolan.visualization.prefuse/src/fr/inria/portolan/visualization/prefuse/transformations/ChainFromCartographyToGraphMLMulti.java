...
import fr.inria.portolan.visualization.prefuse.actions.Cartography2GraphMLMultiAction;
 ...
 *
 */
public class ChainFromCartographyToGraphMLMulti {
...
//		String tmpFolder = tempFolder.toString() + "/.tmp";
		...
		Cartography2GraphMLMultiAction carto2Graph = new Cartography2GraphMLMultiAction();
		IFile graphModel = carto2Graph.perform(model, metamodelURI, tmpFolder, "xmi", monitor);
		
		GraphMLModel2XMLFileAction graph2xml = new GraphMLModel2XMLFileAction();
		IFile graphXmlFile = graph2xml.perform(graphModel, tmpFolder, "graphml", monitor);
