...
import fr.inria.portolan.visualization.linlog.ui.GraphInput;
import fr.inria.portolan.visualization.linlog.ui.LinLogLayoutEditor;

/**
 * @author <a href="mailto:Vincent.Mahe@inria.fr">Vincent Mahe</a>
 *
 */
public class ViewL3Action implements IObjectActionDelegate {
		...
		Display.getDefault().asyncExec(new Runnable() {
			...
			public void run() {
				try {
					...
					IDE.openEditor(page, input, LinLogLayoutEditor.ID, true);
