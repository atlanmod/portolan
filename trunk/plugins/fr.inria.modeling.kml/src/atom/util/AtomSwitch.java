...
public class AtomSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case AtomPackage.PERSON_CONSTRUCT: {
				PersonConstruct personConstruct = (PersonConstruct)theEObject;
				T result = casePersonConstruct(personConstruct);
				if (result == null) result = caseElement(personConstruct);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case AtomPackage.URI: {
			...
			case AtomPackage.EMAIL_ADDRESS: {
				EmailAddress emailAddress = (EmailAddress)theEObject;
				T result = caseEmailAddress(emailAddress);
				if (result == null) result = caseElement(emailAddress);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case AtomPackage.ELEMENT: {
				Element element = (Element)theEObject;
				T result = caseElement(element);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case AtomPackage.AUTHOR: {
				Author author = (Author)theEObject;
				T result = caseAuthor(author);
				if (result == null) result = casePersonConstruct(author);
	 ...
	 * @generated
	 */
	public T casePersonConstruct(PersonConstruct object) {
		return null;
	}
