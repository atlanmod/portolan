...
import fr.inria.portolan.visualization.googlemaps.ui.KMLModelInput;

/**
 * @author <a href="mailto:Vincent.Mahe@inria.fr">Vincent Mahe</a>
 *
 */
public class ViewKMLModelAction implements IObjectActionDelegate {
	...
	public void perform(IFile inFile, String destDir) {
		final KMLModelInput input = new KMLModelInput(inFile);
